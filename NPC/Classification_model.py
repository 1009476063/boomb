...
for i in range(0, 5):
    ...
    for feature_pkl in os.listdir(os.path.join('./20230727/Lasso_features', '{}_{}_{}_{}'.format(base_name, split_name, model_name_new, fold))):
        choosed_features = pickle.load(open(r'./20230727/Lasso_features/{}_{}_{}_{}/{}'.format(base_name, split_name, model_name_new, fold, feature_pkl), 'rb'))
